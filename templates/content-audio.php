...
?>
	...
	<article id="post_<?php the_ID(); ?>" <?php post_class('masonry__brick entry format-audio'); ?> data-aos="fade-up">
		...
		/**
		 * Blog Post Meta
		 * @Hook  heaven_blog_posts_meta
		 *
		 * @Hooked heaven_blog_posts_meta_cb
		 * 
		 *
		 */
		do_action( 'heaven_blog_posts_meta' );
		 ...
		 * @Hook  heaven_blog_posts_excerpt
		 *
		 * @Hooked heaven_blog_posts_excerpt_cb
		 * 
		 *
		 */
		do_action( 'heaven_blog_posts_excerpt' );
