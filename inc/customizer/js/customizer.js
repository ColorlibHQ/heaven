(function( $ , api){
    ...
    api.section( 'heaven_fof_section' , function( section ){
    ...
    // Customizer about page redirect
    api.section( 'heaven_about_section' , function( section ){
    ...
    api.section( 'heaven_blog_section' , function( section ){
    ...
    api.section( 'heaven_portfolio_section' , function( section ){
    ...
    api.section( 'heaven_contact_section' , function( section ){

        section.expanded.bind( function( isExpanded ){

            // Customizer contact form seclector 
            var customshortcodefield = $('#customize-control-heaven_contact_custom_formshortcode'),
                selector = $('#_customize-input-heaven_contact_formshortcode');
    ...
    // General section
    api.section( 'heaven_general_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $preloader      = $('#heaven_preloader_toggle'),
                $preloaderbg    = $( '#customize-control-heaven_preloader_bg_color' ),
                $preloadercolor = $( '#customize-control-heaven_preloader_color' );
            ...
            var $backtotop          = $( '#heaven_backtotop_btn' ),
                $backtotopbg        = $( '#customize-control-heaven_backtotop_btn_bg_color' ),
                $backtotophoverbg   = $( '#customize-control-heaven_backtotop_btn_hover_bg_color' );
    ...
    // Footer section
    api.section( 'heaven_footer_section' , function( section ){
        ...
        section.expanded.bind( function( isExpanded ){
            ...
            var $widget_toggle      = $('#heaven_footer_widget_toggle');
