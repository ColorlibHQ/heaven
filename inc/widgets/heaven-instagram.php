...
----------------------------------------*/
class heaven_instagram_photo extends WP_Widget {
	public function __construct(){
		parent::__construct('heaven_instagram_photo',esc_html__('[ Heaven ] Intagram Photo','heaven'),array(
			'description' => esc_html__('Heaven Instagram Photo Widget','heaven'),
		));
	}
	...
	public function form($instance){
		$title      = isset( $instance['title'] ) ? $instance['title'] : esc_html__('Instagram', 'heaven');
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_user' ) ); ?>"><?php esc_html_e( 'User Name:' ,'heaven'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'insta_items' ) ); ?>"><?php esc_html_e( 'Item Number:' ,'heaven'); ?></label>
...
if(!function_exists('heaven_instagram_widgets')):
	function heaven_instagram_widgets(){
		register_widget('heaven_instagram_photo');
	}
	add_action('widgets_init','heaven_instagram_widgets');
endif;
