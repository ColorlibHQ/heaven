...
// image default alt
if( !function_exists( 'heaven_img_default_alt' ) ){
	function heaven_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'heaven_img_tag' ) ){
	function heaven_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = heaven_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'heaven_anchor_tag' ) ){
	function heaven_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'heaven_heading_tag' ) ){
	function heaven_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'heaven_paragraph_tag' ) ){
	function heaven_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'heaven_other_tag' ) ){
	function heaven_other_tag( array $args ){
...
// Button Element 
if( !function_exists( 'heaven_button_element ' ) ){
	function heaven_button_element( array $args ){
